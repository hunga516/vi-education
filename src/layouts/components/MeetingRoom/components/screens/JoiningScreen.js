...
export function JoiningScreen({
      ...
      <>
        <div>
          <button
            ref={btnRef}
            onClick={onClick}
            className={`rounded-full min-w-auto w-8 h-8 flex items-center justify-center 
  ...
  return (
    <div className="w-full">
      <div className=" flex h-[100vh] flex-col flex-1 bg-white shadow-2xl">
        <div className="flex flex-1 flex-col md:flex-row items-center justify-center p-4">
          <div className="container grid md:grid-flow-col grid-flow-row ">
            <div className="grid grid-cols-12">
                ...
                <div className="flex items-center justify-center">
                  <div className="relative w-full">
                    <div className="w-full relative" style={{ height: "55vh" }}>
                      ...
                      {!isMobile ? (
                        <>
                          <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center">
                            {!webcamOn ? (
                              <p className="text-[12px] font-semibold font-sans leading-6 text-white">
                                Máy ảnh đang tắt
                              </p>
                            ) : null}
                          </div>
                      ...
                      <div className="absolute cccs xl:bottom-6 bottom-4 left-0 right-0">
                        <div className="container grid grid-flow-col space-x-4 items-center justify-center md:-m-2">
                          {isMicrophonePermissionAllowed ? (
                            ...
                            <div className="w-8 h-8 bg-red-500 flex justify-center items-center rounded-full  ">
                              <IoIosMicOff className='text-white' />
                            </div>
                          )}
              ...
              <div className="md:col-span-5 2xl:col-span-5 col-span-12 md:relative flex justify-center items-center h-[415px]">
